...
<div class="wangid_conbox">
	...
	<!-- 筛选 --> 
	<form action="vagueFtypeList.do" method="post" >
	<div class="shuaix">
		<div class="right">
			<input type="text" name="name" placeholder="请输入商品分类名查询">
	...
	<table class="layui-table" lay-filter="mylist" lay-size="lg">
		...
		<tbody>
		 ...
		 <tr>
				...
				<a class="layui-btn layui-btn-danger layui-btn-xs color2"  onclick="return del(1,1,1)" href="deleteFtype.do?id=${u.id }" >删除</a>
				</td>
			</tr>
        </c:forEach> 
		</tbody>  
