...
<body>
    <div class="wangid_conbox">
        ...
        <div class="kehubh_tj_k">
            <form class="layui-form layui-form-pane" action="addGoods.do" method="post" enctype="multipart/form-data" > 
            <ul> 
                <li>
                    <div class="left">商品名：</div>
                    <div class="right"> 
                        <input type="text" name="name" required="required" placeholder="请输入商品名" autocomplete="off" class="layui-input">
                    </div>
                </li>
                <li>
               ...
               <!--  <li>
                ...
                <li>
                    <div class="left">价格（元）：</div>
                    <div class="right"> 
                        <input type="number" min="0"  name="price" value="100"   placeholder="请输入价格" autocomplete="off" class="layui-input">
                    </div>
                </li>
